...
# async def update_permission_by_id(self, role_id: str, role_data: PermissionUpdate) -> Permission:
#     permission = await self._permission_repo.get(role_id)
#     permission.name = role_data.name
#     return await self._permission_repo.update(role)
#
# async def delete_role_by_id(self, role_id: str) -> None:
#     role = await self._permission_repo.get(role_id)
#     self.check_role_allowed_to_delete(role)
#     await self._permission_repo.delete(role)
